...
gsettings set org.gnome.shell.extensions.tiling-assistant tile-bottomleft-quarter "['<Super><Ctrl>comma']"
gsettings set org.gnome.shell.extensions.tiling-assistant tile-bottom-half "['<Super><Ctrl>period']"
gsettings set org.gnome.shell.extensions.tiling-assistant tile-bottomright-quarter "['<Super><Ctrl>slash']"
gsettings set org.gnome.shell.extensions.tiling-assistant tile-left-half "['<Super><Ctrl>l']"
gsettings set org.gnome.shell.extensions.tiling-assistant tile-maximize "['<Super><Ctrl>semicolon']"
gsettings set org.gnome.shell.extensions.tiling-assistant tile-right-half "['<Super><Ctrl>apostrophe']"
gsettings set org.gnome.shell.extensions.tiling-assistant tile-topleft-quarter "['<Super><Ctrl>p']"
gsettings set org.gnome.shell.extensions.tiling-assistant tile-top-half "['<Super><Ctrl>bracketleft']"
gsettings set org.gnome.shell.extensions.tiling-assistant tile-topright-quarter "['<Super><Ctrl>bracketright']"
