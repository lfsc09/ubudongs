...
sudo ln -s $UBUDONGS_ADDITIONAL_TOOLS_DIR/cycle-wallpapers.run.sh /usr/local/bin/cycle-wallpapers
...
sudo ln -s $UBUDONGS_ADDITIONAL_TOOLS_DIR/adjust-background-resolution.run.sh /usr/local/bin/adjust-background-resolution
