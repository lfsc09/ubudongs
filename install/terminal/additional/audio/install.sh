...
sudo ln -s $UBUDONGS_ADDITIONAL_TOOLS_DIR/cycle-output-devices.run.sh /usr/local/bin/cycle-output-devices
...
sudo ln -s $UBUDONGS_ADDITIONAL_TOOLS_DIR/cycle-output-devices.setup.sh /usr/local/bin/cycle-output-devices.setup
