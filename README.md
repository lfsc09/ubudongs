...
For fresh Ubuntu 26.04 installation with GNOME desktop:

```bash
cd /tmp && wget -qO- https://raw.githubusercontent.com/lfsc09/ubudongs/26.04/boot.sh | bash
```
...
```bash
git clone --branch 26.04 git@github.com:lfsc09/ubudongs.git
cd ubudongs
```
